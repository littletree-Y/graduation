...
from real.real_gan.real_train_keywords import real_train_keywords
...
parser.add_argument('--d-architecture', default='rmc_vanilla', type=str, help='Architecture for discriminator')
...
def main():
    ...
    if args.dataset == 'oracle':
        ...
        discriminator = models.get_discriminator(args.d_architecture, batch_size=args.batch_size, seq_len=seq_len,
                                                 vocab_size=vocab_size, dis_emb_dim=args.dis_emb_dim,
                                                 num_rep=args.num_rep, sn=args.sn)
        real_train_keywords(generator, discriminator, oracle_loader, config)
